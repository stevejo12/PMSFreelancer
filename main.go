...
func main() {
	...
	v1 := r.Group("/v1")
	{
		...
		v1.POST("/deletePortfolio", controller.AuthenticationToken, controller.DeleteUserPortfolio)
		v1.POST("/editPortfolio", controller.AuthenticationToken, controller.EditUserPortfolio)
		...
		v1.POST("/updateSkills", controller.AuthenticationToken, controller.UpdateUserSkills)
		...
		v1.GET("/userEducation", controller.AuthenticationToken, controller.GetOnlyUserEducation)
		v1.POST("/addEducation", controller.AuthenticationToken, controller.AddEducation)
		v1.GET("/userExperience", controller.AuthenticationToken, controller.GetOnlyUserExperience)
